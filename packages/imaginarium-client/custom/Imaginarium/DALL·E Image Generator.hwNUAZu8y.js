...
module.exports = (node, graph) => {
  ...
  async function generateImageAndRenderCanvas() {
    ...
    const imageElement = await imageElementCreator.dalleImageGenerationToImageElement({
      prompt: prompt,
      width: 512,
      height: 512
    });
  ...
  const generateImageInput = node.in('DALL·E: Generate Image', generateImageAndRenderCanvas, { connectable: false });
};